...
const voiceIdMap = {
    ...
    "female_voice": 'vghiSqG5ezdhd8F3tKAD', // Example female voice ID - REPLACE WITH YOUR ACTUAL FEMALE VOICE ID FROM ELEVENLABS or use process.env.ELEVENLABS_VOICE_ID_FEMALE
};
